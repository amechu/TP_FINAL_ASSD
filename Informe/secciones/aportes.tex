...
\centering
	\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{Imagenes/Originalmask.png}
		\caption{Imagen Fuente.}
		\label{fig:original}
	\end{subfigure}
		\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{Imagenes/corrmask.png}
		\caption{Correlación con máscara}
		\label{fig:sqdiff}
	\end{subfigure}
	\begin{subfigure}{.1\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{Imagenes/kernelhsv.png}
		\caption{Kernel}
		\label{fig:kernel}
	\end{subfigure}
