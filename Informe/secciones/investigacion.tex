...
\centering
	...
	\begin{subfigure}{.4\textwidth}
		...
		\caption{Matriz de probabilidad}
		\label{fig:probabilidades}
	\end{subfigure}
\end{figure}
La figura \ref{fig:probabilidades} ilustra el proceso de asignar a cada pixel de la imagen la correspondiente probabilidad ocurrencia  de \textbf{HUE} según indique el histograma. Cabe destacar que cada bin del histograma engloba un cierto rango de valores de \textbf{HUE}. Para poder traducir estas probabilidades a valores de intensidad de pixel se realiza un mapeo lineal $[0,1] \rightarrow [0,255]$.
En la secciones posteriores veremos ciertas mejoras que se incorporaron para conseguir una mascara que permita aislar al objeto con más definición.
