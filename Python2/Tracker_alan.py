...
class Tracker:
    ...
    def __init__(self, initialPosition, initialWidth, initialHeight,frame, parametersNew):
        ...
        x = [parametersNew[9], parametersNew[11], parametersNew[12]]

        x_bounds = [(1, 200), (0, 20), (0, 250)]

        #optimize.shgo(self.costChangeParams, x_bounds)
    ...
    def costChangeParams(self, x): # x = [parametersNew[9], parametersNew[11], parametersNew[12]]
        ...
        self.MF.hist_filter.set_kernel_blur(x[1])
        self.MF.hist_filter.set_low_pth(x[2])
        self.MF.updateMaskFromSettings()
